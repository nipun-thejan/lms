...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/course/create/**").hasAnyAuthority(Role.TEACHER.name(), Role.ADMIN.name())
                .requestMatchers("/course/enroll/**", "/course/unenroll/**").hasAuthority(Role.STUDENT.name())
                .requestMatchers("/course/**", "/course/unenroll/**").permitAll()
